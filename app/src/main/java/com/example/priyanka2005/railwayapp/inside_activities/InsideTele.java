...
import com.example.priyanka2005.railwayapp.inside_tele_fragments.DataLoggerFragment;
...
import com.example.priyanka2005.railwayapp.inside_tele_fragments.ElectronicsFragment;
...
import com.example.priyanka2005.railwayapp.inside_tele_fragments.PoliciesFragment;
...
public class InsideTele extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_inside_telecom );
        ...
        switch(data){
            ...
            case "vhf":
                ...
                break;
            case "electronics":
                getSupportFragmentManager().beginTransaction().replace( R.id.inside_fragment_container, new ElectronicsFragment() ).commit();
                break;
            case "disaster":

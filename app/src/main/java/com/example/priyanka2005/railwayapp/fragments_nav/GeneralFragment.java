...
public class GeneralFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        spd = (CardView)view.findViewById( R.id.spd );
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.dar:
                ...
                break;
            case R.id.computer:
                startActivity( new Intent( getContext(), InsideGen.class ).putExtra( "reference","computer" ) );
                break;
            case R.id.spd:
                startActivity( new Intent( getContext(), InsideGen.class ).putExtra( "reference","spd" ) );
                break;
            case R.id.stores:

...
import com.example.priyanka2005.railwayapp.inside_gen_fragments.ComputerFragment;
...
import com.example.priyanka2005.railwayapp.inside_gen_fragments.SPDFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (data){
            ...
            case "dar":
                ...
                break;
            case "computer":
                getSupportFragmentManager().beginTransaction().replace( R.id.inside_fragment_container, new ComputerFragment() ).commit();
                break;
            case "spd":
                getSupportFragmentManager().beginTransaction().replace( R.id.inside_fragment_container, new SPDFragment() ).commit();
                break;
            case "stores":

    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.electronics:
                startActivity( new Intent( getContext(), InsideTele.class ).putExtra( "reference","electronics" ));
                break;
            case R.id.disaster:
                startActivity( new Intent( getContext(), InsideTele.class ).putExtra( "reference","disaster" ));
                break;
            case R.id.policies:
                startActivity( new Intent( getContext(), InsideTele.class ).putExtra( "reference","policies" ));
                break;
            case R.id.test:
